...
/**
 * «апрос на изменение прав доступа пользовател€.
 *             –оли пользовател€ и статус его активности измен€ютс€ только применительно к ’—-за€вителю.
 *          
 * 
    ...
    extends MercuryApplicationRequest
{
     ...
     *                         »змен€ютс€ пол€:
     *                            `enabled` -- активность учетной записи пользовател€
     *                            `authorityList` -- роли пользовател€
