...
/**
 * — версии 2.0 указание даты строкой (элемент informalDate) в запросах не допускаетс€.
 *             ¬ ответах сервиса дата строкой может присутствовать дл€ старых вет.сертификатов/записей складского журнала.
 *          
 * 
