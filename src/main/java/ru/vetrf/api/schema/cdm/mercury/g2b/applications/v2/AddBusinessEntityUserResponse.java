...
/**
 * ќтвет на регистрацию/прив€зку пользовател€(ей) хоз€йствующего субъекта.
 *             ќтвет содержит список пользователей, дл€ которых в результате запроса была выполнена регистраци€/прив€зка.
 *          
 * 
    ...
    extends ApplicationResultData
{
    ...
    /**
     * —ведени€ о зарегистрированном/прив€занном пользователе.Gets the value of the user property.
     * 
     * <p>
