...
/**
 * «а€вка на получение списка версий записей журнала, созданных или измененных за указанный
 *             интервал дат.
 *          
 * 
    ...
    extends MercuryApplicationRequest
{
    ...
    /**
     * 
     *                         ѕараметры запрашиваемого списка.
     *                      
     * 
     * @return
     *     possible object is
    ...
    /**
     * 
     *                         »нтервал времени обновлени€. ¬ список попадают все записи, дата обновлений которых
     *                         попадает в
     *                         указанный интервал.
     *                      
     * 
    ...
    /**
     * »дентификатор предпри€ти€, по которому производитс€ поиск записей.
     *                      
     * 
     * @return
     *     possible object is
